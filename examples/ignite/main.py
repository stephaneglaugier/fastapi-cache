...
from fastapi_cache.backends.ignite import PyIgniteBackend
...
async def startup():
    FastAPICache.init(PyIgniteBackend(ignite_address="127.0.0.1", ignite_port=10800, cache_name="example"))
